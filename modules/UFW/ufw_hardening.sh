...
# Verificar que UFW no esté ya activo
if ufw status | grep -q "Status: active"; then
    echo "[WARNING] UFW ya está activo. ¿Desea continuar? (s/N)"
    read -r response
...
# Resetear configuración actual de UFW
ufw --force reset
...
# Permitir tráfico relacionado/establecido (manejado internamente por UFW)
# UFW ya maneja esto automáticamente con su infraestructura de iptables
...
echo ""
echo "[INFO] Configuración de UFW completada."
